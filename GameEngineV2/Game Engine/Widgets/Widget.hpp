...
//	
//public:
//	virtual void movePosition(Vector2D position){
...
//				Vector2D point = Vector2D(EventHandler::get()->event.button.x,
...
//		if (!father){
//			renderer_->setRendererTarget(NULL);
